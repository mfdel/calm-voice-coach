  ...
  const startVoiceNote = useCallback(() => {
    ...
    if (!SpeechRecognition) {
      toast({
        ...
        description: "Your browser doesn't support speech recognition. Use text instead.",
        variant: "destructive"
      });
      return;
    }
    ...
    recognition.onerror = (event: any) => {
      ...
      if (event.error === "not-allowed") {
        ...
        toast({
          ...
          description: "Couldn't capture audio. Try typing instead.",
          variant: "destructive"
        });
      }
    };
    ...
    return (
      <div className="fixed inset-0 z-50 bg-sos-bg safe-top safe-bottom overflow-auto flex-col flex items-center justify-start">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <div
            className="sos-ambient-blob absolute -bottom-40 -right-20 h-96 w-96 rounded-full bg-[hsl(var(--sos-warm)/0.08)] blur-3xl"
        ...
        <motion.div
          ...
          className="overflow-x-auto flex-row px-[24px] gap-[8px] pt-[5px] pb-[5px] flex items-end justify-end">
      ...
      <div className="fixed inset-0 z-50 flex flex-col bg-sos-bg safe-top safe-bottom overflow-auto">
        ...
        <div className="flex flex-1 flex-col px-6 pt-6 pb-8 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <motion.div
              ...
              className="rounded-2xl bg-sos-muted p-4">
                ...
                <p className="font-display font-bold text-sos-fg text-2xl shadow-sm bg-stone-500">{s.title}</p>
          ...
          <motion.p
            ...
            className="font-display font-extrabold leading-tight tracking-tight text-sos-fg text-lg mx-[30px] px-0">
